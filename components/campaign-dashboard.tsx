...
export default function CampaignDashboard({ campaign, onBack, onDelete, onStatusUpdate, onNameUpdate, initialTab = "contacts" }: CampaignDashboardProps) {
  ...
  const [targetMode, setTargetMode] = useState<'import' | 'scraping'>('scraping')
      ...
      case 'target':
        return (
          <TargetTab
            ...
            setScrappingKeywords={setScrappingKeywords}
            scrappingLocations={scrappingLocations}
            setScrappingLocations={setScrappingLocations}
            scrappingDailyLimit={scrappingDailyLimit}
            setScrappingDailyLimit={setScrappingDailyLimit}
            handleStartScrapping={handleStartScrapping}
            isScrappingActive={isScrappingActive}
