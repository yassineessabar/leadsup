...
export function TargetTab({
  ...
  const handleSaveScraping = () => {
    // Save the scraping configuration to the campaign
    ...
    <div className="w-full animate-in fade-in duration-500">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-2 font-light">Import contacts or set up automated scraping</p>
        </div>
      </div>
      ...
      <Tabs defaultValue="import" className="w-full">
        <TabsList className="grid w-full grid-cols-2 mb-8">
          ...
          <TabsTrigger value="scraping">Auto Scraping</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="scraping" className="space-y-6">
          <Card className="bg-white rounded-3xl border border-gray-100/50 overflow-hidden">
            <CardHeader className="p-8 pb-6">
              <CardTitle className="text-2xl font-medium">LinkedIn Contact Scraping</CardTitle>
              <CardDescription className="mt-2 text-gray-500">
